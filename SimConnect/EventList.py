...
class AircraftEvents():
	...
	class __Lights(EventHelper):
		list = [
			...
			(b'BEACON_LIGHTS_ON', "Turn beacon lights on", "Shared Cockpit"),
			(b'BEACON_LIGHTS_OFF', "Turn beacon loghts off", "Shared Cockpit"),
			(b'BEACON_LIGHTS_SET', "Set beacon lights on/off (1,0)", "Shared Cockpit"),
